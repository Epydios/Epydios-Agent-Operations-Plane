...
7. Real tag release evidence pass (M8.2 / M11 release closure)
   ...
   - Status: `pass` (artifacts archived under `../.epydios/provenance/release-image-digests/`, `../.epydios/provenance/release-images-lockfile-sync/`, and `../.epydios/provenance/releases/20260301T181757Z/`).
