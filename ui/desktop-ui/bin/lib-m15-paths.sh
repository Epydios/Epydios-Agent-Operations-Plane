...
M15_NON_GITHUB_ROOT="${M15_WORKSPACE_ROOT}/EPYDIOS_AI_CONTROL_PLANE_NON_GITHUB"
M15_CACHE_ROOT="${EPYDIOS_M15_CACHE_ROOT:-${M15_NON_GITHUB_ROOT}/internal-readiness/m15-cache}"
