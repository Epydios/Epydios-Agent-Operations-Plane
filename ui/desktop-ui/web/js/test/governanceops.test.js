...
test("governanceops page renders runtime approvals plus identity admin proposal review", () => {
  ...
  assert.match(ui.governanceOpsContent.innerHTML, /Governance Decision Receipt/);
  assert.match(ui.governanceOpsContent.innerHTML, /Selected Approval Deep Review/);
  assert.match(ui.governanceOpsContent.innerHTML, /Governance Route Controls/);
  ...
  assert.match(ui.governanceOpsContent.innerHTML, /step-up governance review/);
