...
test("companionops page renders companion as the daily governance lane with workbench depth handoffs", () => {
  ...
  assert.match(ui.homeOpsContent.innerHTML, /Launcher and runtime/);
  assert.match(ui.homeOpsContent.innerHTML, /Quick pivots/);
  assert.match(ui.homeOpsContent.innerHTML, /Active client/);
  ...
  assert.match(ui.homeOpsContent.innerHTML, /Companion is the daily lane\. Open Workbench only when the item needs deeper review\./);
  assert.match(ui.homeOpsContent.innerHTML, /Review the active governed item here and stay in Companion unless you need deeper evidence, audit, runtime, or incident detail\./);
  ...
  assert.match(ui.homeOpsContent.innerHTML, /Open Audit/);
  assert.match(ui.homeOpsContent.innerHTML, /incident-20260315T161900Z-run-20260315-003/);
  assert.match(ui.homeOpsContent.innerHTML, /Open Incident/);
  assert.match(ui.homeOpsContent.innerHTML, /Open Runtime/);
  ...
  assert.match(ui.homeOpsContent.innerHTML, /Open Evidence/);
  ...
  assert.doesNotMatch(ui.homeOpsContent.innerHTML, /Open RuntimeOps Depth|Open Workbench Review|Open Workbench Depth|Open Evidence Depth|Open AuditOps Depth|Open Incident Depth|Review Live Approvals/);
