...
test("evidenceops page restores visible proof-owner clusters", () => {
  ...
  assert.match(ui.evidenceOpsContent.innerHTML, /Decision Lifecycle/);
  assert.match(ui.evidenceOpsContent.innerHTML, /Routed Decision Spine/);
  ...
  assert.match(ui.evidenceOpsContent.innerHTML, /Decision Record/);
  assert.match(ui.evidenceOpsContent.innerHTML, /Evidence And Trace Refs/);
