...
test("auditops page restores visible event, trace, and investigation clusters", () => {
  ...
  assert.match(ui.auditOpsContent.innerHTML, /Decision Lifecycle/);
  assert.match(ui.auditOpsContent.innerHTML, /Routed Decision Spine/);
  ...
  assert.match(ui.auditOpsContent.innerHTML, /Decision Record/);
  assert.match(ui.auditOpsContent.innerHTML, /Evidence And Trace Refs/);
