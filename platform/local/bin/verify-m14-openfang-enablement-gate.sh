...
WINDOWS_XOS_DEPLOYMENT="${REPO_ROOT}/platform/provider-manifests/oss-desktop-openfang/xos-secure/deployment-windows.yaml"
MACOS_XOS_DEPLOYMENT="${REPO_ROOT}/platform/provider-manifests/oss-desktop-openfang/xos-secure/deployment-macos.yaml"
WINDOWS_XOS_CONFIGMAP="${REPO_ROOT}/platform/provider-manifests/oss-desktop-openfang/xos-secure/configmap-windows.yaml"
MACOS_XOS_CONFIGMAP="${REPO_ROOT}/platform/provider-manifests/oss-desktop-openfang/xos-secure/configmap-macos.yaml"
XOS_KUSTOMIZATION="${REPO_ROOT}/platform/provider-manifests/oss-desktop-openfang/xos-secure/kustomization.yaml"
