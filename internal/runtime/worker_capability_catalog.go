...
func managedCodexWorkerCapabilityEntry() WorkerCapabilityCatalogEntry {
	...
	return WorkerCapabilityCatalogEntry{
		...
		Description:   "AgentOps-managed Codex worker turns with explicit capability-grant and tool-proposal approval kinds, governed approval checkpoints, evidence capture, and gateway-bound provider traffic.",
...
func modelInvokeWorkerCapabilityEntry(profile agentProfileConfig) WorkerCapabilityCatalogEntry {
	...
	return WorkerCapabilityCatalogEntry{
		...
		Description:   "Direct governed model invocation through the runtime integration path without a managed-worker capability-grant approval boundary.",
